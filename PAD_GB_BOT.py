...
import dialogflow
updater = Updater(token='6902855609:AAEmvXhp99KSVPuEG_kHQZSoNGkJSH9-pGs') # Токен API к Telegram
dispatcher = updater.dispatcher
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = 'PADtgbot-cffd-0aac53ba3794.json'# скачнный JSON


DIALOGFLOW_PROJECT_ID = 'PADtgbot-cffd' #PROJECT ID из DialogFlow
DIALOGFLOW_LANGUAGE_CODE = 'ru' # язык
SESSION_ID = 'PADGBTEST_bot'  # ID бота из телеграма
